	...
	function initialize() {
		var mapProp = {
			...
			styles : [{
				...
				elementType : 'http://theembazaar.com/demo/goldey/html/mark-educate/assets/js/labels.text.fill',
				stylers : [{
					color : '#746855'
				}]
			}, {
				...
				featureType : 'http://theembazaar.com/demo/goldey/html/mark-educate/assets/js/poi.park',
				elementType : 'geometry',
				stylers : [{
					color : '#263c3f'
				}]
		...
		var marker = new google.maps.Marker({
			position : myCenter,
			icon : {
				url : 'map-pin.png'/*tpa=http://theembazaar.com/demo/goldey/html/mark-educate/assets/js/assets/images/map-pin.png*/,
